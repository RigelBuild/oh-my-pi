...
| `PI_AI_CLAUDE_CODE_VERSION`      | Claude Code CLI fingerprint version                | Anthropic OAuth requests                                      | Explicitly pins the reported CLI version and disables automatic adoption from server rejection responses |
